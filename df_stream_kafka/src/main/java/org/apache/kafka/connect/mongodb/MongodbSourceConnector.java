...
public class MongodbSourceConnector extends SourceConnector {
    ...
    private static final ConfigDef CONFIG_DEF = new ConfigDef()
            ...
            .define(SCHEMA_NAME, ConfigDef.Type.STRING, ConfigDef.Importance.HIGH, "The schema to publish.")
            .define(BATCH_SIZE, ConfigDef.Type.STRING, ConfigDef.Importance.MEDIUM, "The size of message to commit.")
            .define(TOPIC_PREFIX, ConfigDef.Type.STRING, ConfigDef.Importance.MEDIUM,"The kafka topic prefix")
            .define(DATABASES, ConfigDef.Type.STRING, ConfigDef.Importance.HIGH, "The database name in mongodb.");
    /**
